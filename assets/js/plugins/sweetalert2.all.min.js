!function(e, t) {
    ...
    const c = {
      ...
      , ke = () => {
        const e = m();
        return !!e && (e.remove(),
        k([document.documentElement, document.body], [p["no-backdrop"], p["toast-shown"], p["has-column"]]),
        !0)
    }
      , S = () => {
    ...
    const Me = (e, t) => {
        var n, o, i = m();
        i && (o = i,
        "string" == typeof (n = t.backdrop) ? o.style.background = n : n || A([document.documentElement, document.body], p["no-backdrop"]),
        o = i,
        (n = t.position)in p ? A(o, p[n]) : (a('The "position" parameter is not valid, defaulting to "center"'),
        A(o, p.center)),
        n = i,
        (o = t.grow) && "string" == typeof o && (o = "grow-".concat(o))in p && A(n, p[o]),
        C(i, t, "container"))
    }
    ;
    var L = {
    ...
    (e, t) => {
      ...
      , Ze = (e, t) => {
        var n;
        e.textContent = "",
        t.iconHtml ? y(e, Xe(t.iconHtml)) : "success" === t.icon ? y(e, Ke) : "error" === t.icon ? y(e, Ye) : (n = {
            question: "?",
            warning: "!",
            info: "i"
        },
      ...
      , Ge = (e, o) => {
        ...
        o.progressSteps.forEach( (e, t) => {
            ...
            t !== o.progressSteps.length - 1 && (n = (e => {
                ...
                return A(t, p["progress-step-line"]),
      ...
      , et = (e, t) => {
        ...
        t.toast) ? (A([document.documentElement, document.body], p["toast-shown"]),
        A(n, p.toast)) : A(n, p.modal);
        C(n, t, "popup"),
    ...
    const ht = () => {
      ...
      , Pt = (e, t, n) => {
        ...
        n.heightAuto && n.backdrop && !n.toast && A([document.documentElement, document.body], p["height-auto"])
    }
      , D = e => {
        let t = g();
        t || new wn,
      ...
      , Ht = (e, n, t) => {
        ...
        if (o && (!n.isComposing && 229 !== n.keyCode))
            ...
            "Enter" === n.key)
                ...
                s = n,
                i = o,
                R(i.allowEnterKey) && s.target && e.getInput() && s.target.outerHTML === e.getInput().outerHTML && (["textarea", "file"].includes(i.input) || (jt(),
                s.preventDefault()));
            else if ("Tab" === n.key) {
                e = n;
                var i = o;
    ...
    function Vt(e, t, n, o) {
        ...
        yt(),
        ot()),
        k([document.documentElement, document.body], [p.shown, p["height-auto"], p["no-backdrop"], p["toast-shown"]])
    }
    function Nt(e) {
        ...
        var n = (e => {
            ...
            A(t, n.hideClass.popup);
            const o = m();
            return k(o, n.showClass.backdrop),
            A(o, n.hideClass.backdrop),
            Ft(e, t, n),
            true
        }
        )(this);
        this.isAwaitingPromise() ? e.isDismissed || (Rt(this),
        t(e)) : n && t(e)
    }
    const Rt = e => {
    ...
    const _t = e => {
        e.isAwaitingPromise() ? (Kt(L, e),
        L.awaitingPromise.set(e, !0)) : (Kt(Ot, e),
        Kt(L, e))
    }
      , Kt = (e, t) => {
        for (const n in e)
    ...
    e = Object.freeze({
        ...
        _destroy: function() {
            ...
            delete T.currentInstance) : _t(this)
        }
    });
    const Yt = (e, t) => {
        var n = L.innerParams.get(e);
        if (!n.input)
            return l('The "input" parameter is needed to be set when using returnInputValueOn'.concat(H(t)));
        var o = ( (e, t) => {
            const n = e.getInput();
            if (!n)
                return null;
        ...
        if (n.inputValidator) {
            ...
            e.getInput().checkValidity() ? ("deny" === t ? Zt : $t)(e, o) : (e.enableButtons(),
    ...
    var dn = Object.freeze({
        ...
        bindClickHandler: function() {
            ...
            ln[e] = this,
            cn || (document.body.addEventListener("click", un),
            cn = !0)
        }
    });
    let pn;
    ...
    const mn = (l, u, d) => new Promise( (e, t) => {
        ...
        t = u,
        a = n,
        L.innerParams.get(e).toast ? Gt(e, t, a) : (en(t),
        tn(t),
        nn(e, t, a)),
        o = l,
        e = T,
        ...
        i = n,
        Mt(e),
        t.toast || (e.keydownHandler = e => Ht(o, e, i),
      ...
      , vn = (e, t) => t.focusDeny && E(e.denyButton) ? (e.denyButton.focus(),
    ...
    !0)
      ...
      , wn = (Object.assign(I.prototype, e),
    Object.assign(I, dn),
    Object.keys(e).forEach(e => {
        I[e] = function() {
            if (pn)
                return pn[e](...arguments)
        }
    }
    ),
    I.DismissReason = j,
